...
public class FiveLineTests {
    ...
    public async Task BlankLinesAreSkipped() {
        TXTConfigFile reader = new TXTConfigFile("../../../TXT/5LineTests/WithSpaces.txt");
        await Assert.That(reader["Lorem"].AsString()).IsEqualTo("Test string");
        await Assert.That(reader["Lorem2"].AsInt()).IsEqualTo(15);
        await Assert.That(reader["Lorem3"].AsDouble()).IsEqualTo(3.25);
        await Assert.That(reader["Lorem4"].AsBool()).IsEqualTo(true);
...
public class SingleLineArrayTests {
    ...
    public async Task StringsAreParsed() {
        TXTConfigFile reader = new TXTConfigFile("../../../TXT/SingleLineArrayTests/Strings.txt");
    ...
    public async Task IntsAreParsed() {
        TXTConfigFile reader = new TXTConfigFile("../../../TXT/SingleLineArrayTests/Ints.txt");
    ...
    public async Task DoublesAreParsed() {
        TXTConfigFile reader = new TXTConfigFile("../../../TXT/SingleLineArrayTests/Doubles.txt");
    ...
    public async Task BoolsAreParsed() {
        TXTConfigFile reader = new TXTConfigFile("../../../TXT/SingleLineArrayTests/Bools.txt");
    ...
    public async Task MixedArrayIsParsed() {
        TXTConfigFile reader = new TXTConfigFile("../../../TXT/SingleLineArrayTests/Mixed.txt");
...
public class MultiLineArrayTests {
    ...
    public async Task TwoLineArrayTest() {
        TXTConfigFile reader = new TXTConfigFile("../../../TXT/MultiLineArrayTests/TwoLineArray.txt");
    ...
    public async Task FourLineArrayTest() {
        TXTConfigFile reader = new TXTConfigFile("../../../TXT/MultiLineArrayTests/FourLineArray.txt");
    ...
    public async Task UnclosedArrayThrowsError() {
        await Assert.That(() => new TXTConfigFile("../../../TXT/MultiLineArrayTests/Unclosed.txt"))
            .Throws<FormatException>()
    ...
    public async Task UnclosedArrayStopsBeforeNextKVP() {
        await Assert.That(() => new TXTConfigFile("../../../TXT/MultiLineArrayTests/Unclosed2.txt"))
            .Throws<FormatException>()
            .WithMessage("Error parsing array around line 3. Please ensure you have a closing array brace.");
    }
}
public class RealisticTests {
    ...
    public async Task AIGeneratedSlop1() {
        TXTConfigFile reader = new TXTConfigFile("../../../TXT/Realistic/File2.txt");
    ...
    public async Task AIGeneratedSlop2() {
        ...
        TXTConfigFile reader = new TXTConfigFile("../../../TXT/Realistic/File3.txt");
