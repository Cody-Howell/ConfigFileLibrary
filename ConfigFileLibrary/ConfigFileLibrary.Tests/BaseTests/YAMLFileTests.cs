...
public class FirstOrderYAMLFileTests {
    ...
    public async Task PrimitiveTest2() {
        ConfigFile reader = new ConfigFile("../../../data/YAML/FirstOrder/Primitive2.yaml");
    ...
    public async Task ObjectTest() {
        ConfigFile reader = new ConfigFile("../../../data/YAML/FirstOrder/Object.yaml");
    ...
    public async Task BrokenObjectThrowsError() {
        await Assert.That(() => new ConfigFile("../../../data/YAML/FirstOrder/BrokenObject.yaml"))
    ...
    public async Task ArrayTest() {
        ConfigFile reader = new ConfigFile("../../../data/YAML/FirstOrder/Array.yaml");
...
public class SecondOrderYAMLFileTests {
    ...
    public async Task ObjectWithArray() {
        ConfigFile reader = new ConfigFile("../../../data/YAML/SecondOrder/ObjectWithArray.yaml");
    ...
    public async Task ArrayWithObject() {
        ConfigFile reader = new ConfigFile("../../../data/YAML/SecondOrder/ArrayWithObject.yaml");
    ...
    public async Task ArrayWithArray() {
        ConfigFile reader = new ConfigFile("../../../data/YAML/SecondOrder/ArrayWithArray.yaml");
    ...
    public async Task MixedArray() {
        ConfigFile reader = new ConfigFile("../../../data/YAML/SecondOrder/MixedArray.yml");
