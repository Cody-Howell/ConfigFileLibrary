...
public class FirstOrderTests {
    ...
    public async Task ArrayTest() {
        JSONConfigFile reader = new JSONConfigFile("../../../JSON/FirstOrder/SimpleArray.json");
    ...
    public async Task ObjectTest() {
        JSONConfigFile reader = new JSONConfigFile("../../../JSON/FirstOrder/SimpleObject.json");
    ...
    public async Task IntArrayTest() {
        JSONConfigFile reader = new JSONConfigFile("../../../JSON/FirstOrder/IntArray.json");
...
public class SecondOrderTests {
    ...
    public async Task ArrayWithArray() {
        JSONConfigFile reader = new JSONConfigFile("../../../JSON/SecondOrder/ArrayWithArray.json");
    ...
    public async Task ArrayWithObject() {
        JSONConfigFile reader = new JSONConfigFile("../../../JSON/SecondOrder/ArrayWithObject.json");
    ...
    public async Task ObjectWithObject() {
        JSONConfigFile reader = new JSONConfigFile("../../../JSON/SecondOrder/ObjectWithObject.json");
    ...
    public async Task ObjectWithArray() {
        JSONConfigFile reader = new JSONConfigFile("../../../JSON/SecondOrder/ObjectWithArray.json");
